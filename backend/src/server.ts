...
import { initializeSocket } from './utils/socket.js'; // Socket uchun yordamchi
...
initializeSocket(io); // io instance'ini global saqlash
...
if (process.env.NODE_ENV !== 'test') {
  ...
  // Endi app.listen o'rniga server.listen ishlatiladi
  server.listen(PORT, () => {
